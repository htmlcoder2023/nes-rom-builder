...
bytes = input("File with Bytes: ")
bytesLoc = input("File with Byte Locations: ")

if os.path.isfile(bytes) and os.path.isfile(bytesLoc):
...
while satisfied == False:
    ...
    romSHA256 = str(hashlib.sha256(prgRead).hexdigest())
